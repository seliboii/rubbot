...
static const _DutyCycles_type_support_symbol_names_t _DutyCycles_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robp_interfaces, msg, DutyCycles)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robp_interfaces, msg, DutyCycles)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robp_interfaces, msg, DutyCycles)() {
  return &::robp_interfaces::msg::rosidl_typesupport_c::DutyCycles_message_type_support_handle;
}
