...
static const _Encoders_type_support_symbol_names_t _Encoders_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robp_interfaces, msg, Encoders)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robp_interfaces, msg, Encoders)),
  }
};
...
get_message_type_support_handle<robp_interfaces::msg::Encoders>()
{
  return &::robp_interfaces::msg::rosidl_typesupport_cpp::Encoders_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robp_interfaces, msg, Encoders)() {
  return get_message_type_support_handle<robp_interfaces::msg::Encoders>();
}
