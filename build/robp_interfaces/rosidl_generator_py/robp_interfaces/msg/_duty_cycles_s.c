...
bool robp_interfaces__msg__duty_cycles__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robp_interfaces.msg._duty_cycles.DutyCycles", full_classname_dest, 43) == 0);
  }
  robp_interfaces__msg__DutyCycles * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of DutyCycles */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robp_interfaces.msg._duty_cycles");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DutyCycles");
