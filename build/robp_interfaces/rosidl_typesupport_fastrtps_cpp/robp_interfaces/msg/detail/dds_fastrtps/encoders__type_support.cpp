...
#include "robp_interfaces/msg/detail/encoders__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robp_interfaces::msg::Encoders & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robp_interfaces::msg::Encoders & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robp_interfaces::msg::Encoders;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robp_interfaces::msg::Encoders *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robp_interfaces::msg::Encoders *>(
    untyped_ros_message);
...
{
  return &robp_interfaces::msg::typesupport_fastrtps_cpp::_Encoders__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robp_interfaces, msg, Encoders)() {
  return &robp_interfaces::msg::typesupport_fastrtps_cpp::_Encoders__handle;
}
