...
#include "robp_interfaces/msg/detail/duty_cycles__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robp_interfaces::msg::DutyCycles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robp_interfaces::msg::DutyCycles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robp_interfaces::msg::DutyCycles *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _DutyCycles__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const robp_interfaces::msg::DutyCycles *>(
...
static size_t _DutyCycles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_DutyCycles(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _DutyCycles__callbacks = {
  "robp_interfaces::msg",
  "DutyCycles",
...
static rosidl_message_type_support_t _DutyCycles__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_DutyCycles__callbacks,
...
{
  return &robp_interfaces::msg::typesupport_fastrtps_cpp::_DutyCycles__handle;
}
