...
class Odometry(Node):
    ...
    def encoder_callback(self, msg: Encoders):
        ...
        dt = 50 / 1000
        ticks_per_rev = 3200
        wheel_radius = 0.0492125  # TODO: Fill in
        base = 0.31  # TODO: Fill in
        K = 2*math.pi*wheel_radius/(ticks_per_rev*dt)
        # Ticks since last message
        delta_ticks_left = msg.delta_encoder_left
        delta_ticks_right = msg.delta_encoder_right

        # TODO: Fill in
        D = (wheel_radius*K/2)*(delta_ticks_right+delta_ticks_left)
        delta_theta = (wheel_radius*K/(base))*(delta_ticks_right-delta_ticks_left)
